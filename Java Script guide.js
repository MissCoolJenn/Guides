...
// Анонимная фукнция (анолог однострочной лямбды в пайтон)
console.log(function() {
    return'some test to print'
})

// Стрелочная фукнция
let name = 'Shrek'
let full_name = name => {
//                ^ переменная из текущей области видимости что будет передана в функцию
//                ^ либо () если ничего не нужно передавать 
    return `Hi, ${name}!`
}
